...
const popoverHeader = tv({
  base: 'border-b border-b-gray-300/30 p-[var(--padding)]',
});

const popoverFooter = tv({
  base: 'border-t border-t-gray-300/30 p-[var(--padding)]',
});

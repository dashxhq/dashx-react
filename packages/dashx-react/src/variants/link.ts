...
const link = tv({
  extend: text,
  base: 'underline-offset-2 data-[focus-visible]:outline-2 data-[focus-visible]:outline-offset-2 data-[disabled]:pointer-events-none data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50',
  variants: {
    align: {},
    size: {},
    weight: {},
    color: {
      ...
      gray: 'data-[focus-visible]:outline-accent-500 decoration-accent-500',
